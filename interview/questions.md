...
<img src="./img/pic.png" style="zoom:50%;" />
...
具体详见[前端登录](https://juejin.im/post/6845166891393089544#heading-9)

方案1：cookie + session

方案2：token

方案3：单点登录指的是在公司内部搭建一个公共的认证中心，公司下的所有产品的登录都可以在认证中心里完成，一个产品在认证中心登录后，再去访问另一个产品，可以不用再次登录，即可获取登录状态。

方案4：OAuth 第三方登录，例如微信、qq、微博等
